...
const WorkoutDetailsPage = async ({ params }) => {
  ...
  return (
    <main className="min-h-screen border-t border-white/10 bg-[#090a0c] px-6 py-30">
      <section className="mx-auto max-w-7xl">
        <div className="rounded-2xl border border-white/10 bg-[#111318] p-5 md:p-7">
          <div className="grid gap-9 lg:grid-cols-2">
            <div className="group overflow-hidden rounded-xl border border-white/10 bg-[#181a1f]">
              <img
                src={image}
                alt={name}
            ...
            <div className="rounded-xl border border-white/10 bg-[#15171c] p-5">
              ...
              <div className="mt-5 overflow-hidden rounded-xl border border-white/10 bg-[#1b1d22]">
              ...
              <div className="mt-5 rounded-xl border border-white/10 bg-[#1b1d22] p-4">
